...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tempParams = new GridLayout.LayoutParams(GridLayout.spec(0),GridLayout.spec(1,4, 1));
        tv.setLayoutParams(tempParams);
        gl.addView(tv);
        ...
        tempParams = new GridLayout.LayoutParams(GridLayout.spec(1, 2),GridLayout.spec(4));
        ...
        tempParams = new GridLayout.LayoutParams(GridLayout.spec(2, 2),GridLayout.spec(4));
        tempParams.setGravity(Gravity.LEFT);
        tv.setLayoutParams(tempParams);
        gl.addView(tv);
